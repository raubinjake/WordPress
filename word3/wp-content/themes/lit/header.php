...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'lit' ); ?></a>

	<?php
		get_template_part( 'template-parts/header/' . jetblack_gtm( 'jetblack_header_style' ) );
